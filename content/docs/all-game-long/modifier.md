...
Fork [le dépôt](https://github.com/loshido/agl-bet) (vous créez une copie du dépôt sur votre compte),
...
Enfin vous devrez proposer une pull request sur le [dépôt](https://github.com/loshido/agl-bet/).
{{< callout type="info" >}}
